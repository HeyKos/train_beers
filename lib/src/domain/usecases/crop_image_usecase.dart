...
class CropImageUseCase
    extends UseCase<CropImageUseCaseResponse, CropImageUseCaseParams> {
  CropImageUseCase();

  @override
  Future<Stream<CropImageUseCaseResponse>> buildUseCaseStream(
      CropImageUseCaseParams params) async {
    final controller = StreamController<CropImageUseCaseResponse>();
